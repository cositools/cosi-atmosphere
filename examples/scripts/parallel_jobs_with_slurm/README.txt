This is an example of running parallel jobs with slurm, using a packable partition. We simulate a total of 10^7 photons using 10^3 parallel cores, and so on core we simulate 10^4 photons.
